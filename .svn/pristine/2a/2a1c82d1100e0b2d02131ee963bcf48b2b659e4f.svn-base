...
function page(current){
	...
	var json = {
		"keyword":KEYWORD
            ...
            ajaxPost(
              'app_dev.php/api/recommended/retrieveByFilterNum',
              json,
...
function pageTemp(current,json,interfaceType){
	var current = current;
	var url="app_dev.php/api/"+interfaceType+"/retrieveByFilterNum";
	//获得总数据量 
    ajaxPost(
      url,
      json,
...
function videopage(current){
	...
	var json = {
		...
		"isrest":ISREST
            ...
            ajaxPost(
              'app_dev.php/api/video/getAllVideoListNum',
              json,
              function(data, textStatus){
				var count = data;//总条数
				if(current == 0)
...
function userpage(current){
	...
	var json = {
		"keyword":KEYWORD
            ...
            ajaxPost(
              'app_dev.php/api/user/retrieveByFilterNum',
              json,
              function(data, textStatus){
				var count = data;//总条数
				if(current == 0)
...
function orderpage(current){
	...
	var json = {
            ...
            ajaxPost(
              'app_dev.php/api/order/retrieveByFilterNum',
              json,
              function(data, textStatus){
				var count = data;//总条数
				if(current == 0)
