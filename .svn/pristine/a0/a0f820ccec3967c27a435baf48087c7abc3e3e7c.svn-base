...
class MarketController extends Controller
{
    ...
    */
    ...
    public function addAction(Request $request)
    {
		...
		$this->get('my_datebase')->connection();
		$sql = "insert into market set title = '$title',summary='$summary',content = '$content',image_url = '$image_url', creation_date = $current,updated_date=$current";
		//return new Response($sql);
		mysql_query($sql);
		$id = mysql_insert_id();
		if($image_ids){
			...
			if(strstr($image_ids,",")){
				...
				mysql_query("insert into market_image set market_id =$id ,image_id = $image_ids");
			}
		}
    ...
    public function updateAction(Request $request)
    {
    	...
    	$sql = "update market set title = '$title',summary='$summary',content = '$content',image_url = '$image_url',updated_date=$current where id=$id";
    	//return new Response($sql);
    	mysql_query($sql);
    	//$id = mysql_insert_id();
