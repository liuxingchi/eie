...
class RememberMeFactory implements SecurityFactoryInterface
{
    ...
    {
    	//file_put_contents("/home/wwwroot/log/log_maqiang5.txt",print_r($config, true), FILE_APPEND);
        ...
        if (isset($config['token_provider'])) {
            ...
            //file_put_contents("/home/wwwroot/log/log_" . date("Y-m-d") . ".txt", $rememberMeServicesId.'\n', FILE_APPEND);
        } else {
