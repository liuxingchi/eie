...
/**************************请求参数**************************/
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = "http://medicine.yingdongzhuoyue.com/alipay/create_direct_pay_by_user/notify_url.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数        //页面跳转同步通知页面路径
        $return_url = "http://medicine.yingdongzhuoyue.com/alipay/create_direct_pay_by_user/return_url.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/        //卖家支付宝帐户
        $seller_email = "116090453@qq.com";
        //必填        //商户订单号
        ...
        //商品展示地址
        $show_url = "http://medicine.yingdongzhuoyue.com";
